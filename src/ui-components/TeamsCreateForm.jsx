...
import { createTeams } from "../graphql/mutations";
export default function TeamsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPlayedSince(initialValues.playedSince);
    setVenue(initialValues.venue);
    setHometown(initialValues.hometown);
    setOfficialURL(initialValues.officialURL);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createTeams.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
